...
// Legislation Items
export const legislation = mysqlTable("legislation", {
  id: varchar("id", { length: 36 }).primaryKey(),
  title: text("title").notNull(),
  description: text("description").notNull(),
...
// Slideshow Slides
export const slideshow = mysqlTable("slideshow", {
  id: varchar("id", { length: 36 }).primaryKey(),
  title: text("title").notNull(),
  subtitle: text("subtitle"),
  description: text("description").notNull(),
  imageUrl: text("image_url").notNull(), // URL to the slide image
  order: int("order").notNull().default(0), // Order of display
  isActive: boolean("is_active").notNull().default(true),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const activityPlan = mysqlTable("activity_plan", {
  id: varchar("id", { length: 36 }).primaryKey(),
...
export const activityPlanItems = mysqlTable("activity_plan_items", {
  id: varchar("id", { length: 36 }).primaryKey(),
  planId: varchar("plan_id", { length: 36 }).notNull().references(() => activityPlan.id, { onDelete: 'cascade' }),
  number: int("number").notNull(), // Número da atividade
  ...
  order: int("order").notNull().default(0), // Ordem de exibição
...
export const orgaosSociais = mysqlTable("orgaos_sociais", {
  id: varchar("id", { length: 36 }).primaryKey(),
  name: text("name").notNull(),
