    ...
    <div className={className}>
      ...
      <div className="relative">
        ...
        <input 
          ...
          } rounded-xl ${icon ? 'pl-11' : 'pl-4'} pr-4 py-3 text-sm text-gray-900 dark:text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-all shadow-sm placeholder:text-gray-400 disabled:opacity-50`} 
          {...props}
        />
      </div>
