...
import { Add01Icon as Plus, Search01Icon as Search, FilterHorizontalIcon as Filter, Edit02Icon as Edit2, Delete02Icon as Trash2, ViewIcon as Eye, Image01Icon as ImageIcon, Upload01Icon as Upload } from "hugeicons-react";
...
const AdminGallery = () => {
    ...
    try {
      ...
      if (file) {
        ...
        if (file.type.startsWith('image/')) {
          ...
          data.type = 'video';
          // Para vídeos, usar a primeira frame como thumbnail ou manter thumbnailUrl se já existir
          if (!data.thumbnailUrl) {
            // Se não houver thumbnail, usar o próprio vídeo (o navegador pode gerar uma thumbnail)
            data.thumbnailUrl = uploadedFileUrl;
          }
        }
      }
  ...
  const handleUpdateGalleryItem = async (data: any, file?: File) => {
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <GalleryDialog
          ...
          onSubmit={(data, file) => handleUpdateGalleryItem(data, file)}
