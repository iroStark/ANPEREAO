...
import { FileText, Download, Scale, Building, Calendar } from "lucide-react";
  ...
  return (
    <section className="py-16 bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <Badge variant={document.status === "Vigente" ? "default" : "secondary"}>
                          {document.status}
                        </Badge>
                      </div>
                    </div>
                  </div>
                  <CardTitle className="text-xl" data-testid={`text-document-title-${document.id}`}>
                    {document.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="flex gap-3">
                    <Button className="flex-1" data-testid={`button-view-document-${document.id}`}>
                      <FileText className="w-4 h-4 mr-2" />
                      Visualizar
                    </Button>
                    <Button variant="outline" data-testid={`button-download-document-${document.id}`}>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center" data-testid="text-legal-info-title">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <Button variant="outline" className="w-full" data-testid="button-legal-compliance">
                  <FileText className="w-4 h-4 mr-2" />
